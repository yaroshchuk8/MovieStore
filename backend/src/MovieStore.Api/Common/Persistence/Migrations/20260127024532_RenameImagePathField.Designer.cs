...
namespace MovieStore.Infrastructure.Migrations
{
    ...
    [Migration("20260127024532_RenameImagePathField")]
    partial class RenameImagePathField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieStore.Domain.Users.PublisherProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieStore.Domain.Movies.Movie", b =>
                {
                    b.HasOne("MovieStore.Domain.Users.PublisherProfile", "PublisherProfile")
                        .WithMany("Movies")
            ...
            modelBuilder.Entity("MovieStore.Domain.Users.PublisherProfile", b =>
                {
                    b.HasOne("MovieStore.Domain.Users.UserProfile", "UserProfile")
                        ...
                        .HasForeignKey("MovieStore.Domain.Users.PublisherProfile", "UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
